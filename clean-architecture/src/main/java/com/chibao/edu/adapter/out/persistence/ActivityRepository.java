...
public interface ActivityRepository extends JpaRepository<ActivityJpaEntity, Long> {
    ...
    @Query("""
            select a from ActivityJpaEntity a\s
    ...
    @Query("""
            ...
            """)
    Optional<Long> getDepositBalanceUntil(@Param("accountId") long accountId, @Param("until") LocalDateTime until);
    ...
    @Query("""
            ...
            and a.timestamp < :until
            """)
    Optional<Long> getWithdrawalBalanceUntil(@Param("accountId") long accountId, @Param("until") LocalDateTime until);
}
